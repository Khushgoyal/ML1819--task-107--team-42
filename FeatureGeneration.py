...
""" This function gives the number of lowercase characters in a tweet """
def n_lower_chars(stringx):
    return sum(1 for c in stringx if c.islower())


""" This function gives the number of uppercase characters in a tweet """
def n_upper_chars(stringx):
    return sum(1 for c in stringx if c.isupper())


""" This function gives the number of digits in a tweet """
def n_digit_chars(stringx):
    return sum(1 for c in stringx if c.isdigit())


""" This function gives the number of punctuation characters in a tweet """
def n_punctuation_chars(stringx):
    return sum(1 for c in stringx if c in string.punctuation)


""" This function gives the number of words in a tweet """
def n_words(text):
    num_words = text.split()
    return len(num_words);


""" This function gives the number of User Mentions in a tweet """
def n_user_mentions(stringx):
    stringx = re.sub('@\S+', 'THIS_IS_A_MENTION', stringx)
    return (stringx.count('THIS_IS_A_MENTION'))


""" This function gives the number of hashtags in a tweet """
def n_hashtags(text):
    matched = 0
...
""" This function gives the number of URLS in a tweet """
def n_urls(stringx):
        stringx = re.sub('http\S+', 'THIS_IS_A_URL', stringx)
        return (stringx.count('THIS_IS_A_URL'))


""" This function gives the number of emoticons in a tweet """
...
""" This function replaces the URLS, Hashtags and User Mentions in a tweet """
...
""" This function calculates the hapax legomenon ratio: word that appears only 
once in a whole text to the total number of words """
...
""" This function calculates the hapax dislegomenon ratio: word that appears only 
twice in a whole text to the total number of words """
...
""" This function matches a hex colour code to the nearest colour in the color_list """
...
""" Calculates the different feature values for the descriptions of the user and populates the featured_user_data.cs """
...
""" Calculates the different feature values for all the tweets of the user and populates the featured_tweet_data.csv """
